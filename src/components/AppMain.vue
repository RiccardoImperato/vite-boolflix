...
<template>
    <main>
        <!-- Trends -->
        <section v-if="store.movieList.length === 0 || store.tvList.length === 0">
            <h2 v-if="store.trendsList.length">Trends</h2>
            <ul>
                <!-- Card component for trends -->
                <li v-for="trend in store.trendsList" class="card">
        ...
        <!-- Movies -->
        <section>
            <h2 v-if="store.movieList.length">Movies</h2>
            <ul>
                <!-- Card component for movies -->
                <li v-for="movie in store.movieList" class="card">
        ...
        <!-- Series -->
        <section>
            <h2 v-if="store.tvList.length">Series</h2>
            <ul>
                <!-- Card component for series -->
                <li v-for="serie in store.tvList" class="card">
